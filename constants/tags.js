 ...
 * 
 * @source_origin 원본 App.jsx 3744-4950줄
 * 
 * @description
 * 대장르, 부장르, 일반 태그, 캐릭터 카테고리, 감성 분류,
 * 스펙트럼 그룹, 좌표계 시스템, 태그 alias 등 모든 태그 관련 상수와 헬퍼 함수
 * 
 * @version v5.0 - 농도(intensity) + 스펙트럼 + alias 지원
 */
